<template>
  <div class="p-6">
    <button
      @click="goBack"
      class="mb-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray-800 bg-gray-200 rounded-lg hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300"
    >
